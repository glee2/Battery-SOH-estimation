...
from model import init_weights, AlexNet, AlexNet_light, LSTMRegressor
        ...
        for target_cycle in target_cycles:
            ...
            for fold in range(n_folds):
                ...
                if image_type == "LSTM":
                    ...
                    data_module = TSDataModule(device, ts_dataset, cv_fold=fold, batch_size=len(ts_dataset, shuffle=True))
